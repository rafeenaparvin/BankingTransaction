...
public class AccountController {
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "Account created", response = Account.class)})
    ...
    @ApiResponses({@ApiResponse(code = 200, message = "Received statement", response = AccountStatement.class)})
